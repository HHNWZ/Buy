...
public class Mess extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view=inflater.inflate(R.layout.fragment_mess, container, false);
    ...
    void setupTab(){
        mTabLayout.getTabAt(0).setText("買方");
        mTabLayout.getTabAt(1).setText("賣方");
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Buy());
        adapter.addFragment(new Sale());
